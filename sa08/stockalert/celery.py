...
app.conf.beat_schedule = {
    ...
    # Single heavy automatic pipeline kept on purpose. Legacy standalone
    # fetch/compute/send schedules are disabled in settings.py so a non-tracked
    # fetch cannot monopolize the solo worker and leave tracked jobs pending.
