...
APP_VERSION = os.getenv("APP_VERSION", "V8.0.04")
...
CELERY_TASK_REJECT_ON_WORKER_LOST = os.getenv("CELERY_TASK_REJECT_ON_WORKER_LOST", "0") == "1"
CELERY_WORKER_PREFETCH_MULTIPLIER = int(os.getenv("CELERY_WORKER_PREFETCH_MULTIPLIER", "1"))
CELERY_WORKER_CONCURRENCY = int(os.getenv("CELERY_WORKER_CONCURRENCY", "1"))
CELERY_TASK_TRACK_STARTED = os.getenv("CELERY_TASK_TRACK_STARTED", "1") == "1"
...
JOB_RECOVER_ORPHANED_ON_WORKER_READY = os.getenv('JOB_RECOVER_ORPHANED_ON_WORKER_READY', '1') == '1'
JOB_FULL_RECOMPUTE_INSTRUMENTATION = os.getenv('JOB_FULL_RECOMPUTE_INSTRUMENTATION', '1') == '1'
JOB_FULL_RECOMPUTE_LOG_EVERY_N_SYMBOLS = int(os.getenv('JOB_FULL_RECOMPUTE_LOG_EVERY_N_SYMBOLS', '1'))
JOB_FULL_RECOMPUTE_LOG_EVERY_N_DATES = int(os.getenv('JOB_FULL_RECOMPUTE_LOG_EVERY_N_DATES', '200'))
